...
// in stealth_clip/test/mocks.dart.
...
import 'package:stealth_clip/providers/stealth_text_provider.dart' as _i6;
import 'package:stealth_clip/services/secure_storage_service.dart' as _i3;
...
class MockSecureStorageService extends _i1.Mock
  ...
  @override
  _i4.Future<void> saveEntries(List<_i3.StealthEntry>? entries) =>
      (super.noSuchMethod(
        Invocation.method(
          #saveEntries,
          [entries],
  ...
  @override
  _i4.Future<List<_i3.StealthEntry>> getEntries() => (super.noSuchMethod(
        Invocation.method(
          #getEntries,
          [],
        ),
        returnValue:
            _i4.Future<List<_i3.StealthEntry>>.value(<_i3.StealthEntry>[]),
      ) as _i4.Future<List<_i3.StealthEntry>>);
...
/// A class which mocks [StealthTextProvider].
///
/// See the documentation for Mockito's code generation for more information.
class MockStealthTextProvider extends _i1.Mock
    implements _i6.StealthTextProvider {
  MockStealthTextProvider() {
    _i1.throwOnMissingStub(this);
  }

  @override
  List<_i3.StealthEntry> get entries => (super.noSuchMethod(
        Invocation.getter(#entries),
        returnValue: <_i3.StealthEntry>[],
      ) as List<_i3.StealthEntry>);
  ...
  @override
  _i4.Future<void> copyToClipboard(int? index) => (super.noSuchMethod(
        Invocation.method(
          #copyToClipboard,
          [index],
        ),
  ...
  @override
  _i4.Future<void> clearEntry(int? index) => (super.noSuchMethod(
        Invocation.method(
          #clearEntry,
          [index],
        ),
  ...
  @override
  _i4.Future<void> addNewEntry() => (super.noSuchMethod(
        Invocation.method(
          #addNewEntry,
          [],
        ),
  ...
  @override
  _i4.Future<void> removeEntry(int? index) => (super.noSuchMethod(
        Invocation.method(
          #removeEntry,
          [index],
        ),
  ...
  @override
  _i4.Future<void> clearAllEntries() => (super.noSuchMethod(
        Invocation.method(
          #clearAllEntries,
          [],
        ),
